...
- pre-defined templates (Profiles)  
  - [ControllerTemplate (P)](./schemas/10_ControllerTemplate.yaml)  
  - [MediatorVmTemplate (P)](./schemas/20_MediatorVmTemplate.yaml)  
  - [DeviceTemplate (P)](./schemas/30_DeviceTemplate.yaml)  
